...
def tacosandburritos_train(
    ...
    operations['preprocess'] = dsl.ContainerOp(
        name='preprocess',
        image='kubeflowacr.azurecr.io/preprocess:' + str(imagetag),
        command=['python'],
        arguments=[
            '/scripts/data.py',
    ...
    operations['training'] = dsl.ContainerOp(
        name='training',
        image='kubeflowacr.azurecr.io/training:' + str(imagetag),
        command=['python'],
        arguments=[
            '/scripts/train.py',
            '--base_path', persistent_volume_path,
    ...
    operations['register'] = dsl.ContainerOp(
        name='register',
        image='kubeflowacr.azurecr.io/register:' + str(imagetag),
        command=['python'],
        arguments=[
            '/scripts/register.py',
            '--base_path', persistent_volume_path,
